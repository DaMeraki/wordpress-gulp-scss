...
function riker_styles() {
    ...
    wp_enqueue_style( 'main-css', get_stylesheet_directory_uri() . '/assets/css/style.css', [ 'reset-css' ], $version, 'all' );
    wp_enqueue_style( 'reset-css', get_stylesheet_directory_uri() . '/assets/css/reset.css', array(), $version, 'all' );
